          ...
          >
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[9px] font-black uppercase bg-indigo-50 text-indigo-700 px-1.5 py-0.5 rounded border border-indigo-100">
                  {item.tipo}
                </span>
              </div>
            </div>
            ...
            <div className="border-t border-gray-50 pt-2 flex items-center justify-between text-[9px] font-bold text-gray-400">
              ...
              <div className="text-right text-xs font-black text-gray-950 flex flex-col">
                {item.monto_usd > 0 && <span className="text-indigo-600">{formatUSD(item.monto_usd)}</span>}
        ...
        {paginatedItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Monto $ */}
              <td className="px-4 py-2 whitespace-nowrap text-sm font-black text-indigo-600 text-right">
